...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<fd-big-input-action></fd-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<fd-big-input-action [disabled]="true"></fd-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<fd-big-input-action fontSet="fas" fontIcon="trash"></fd-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<fd-big-input-action label="delete"></fd-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<fd-big-input-action (action)="actionHandler()"></fd-big-input-action>';
    fixture = createHostComponent(template);
