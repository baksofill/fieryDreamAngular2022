...
export const features: Feature[] = [
  {
    ...
    description: 'fd.features.angular',
  ...
  },
  {
    ...
    description: 'fd.features.angular-material',
  ...
  },
  {
    ...
    description: 'fd.features.angular-cli',
  ...
  },
  {
    ...
    description: 'fd.features.bootstrap',
  ...
  },
  {
    ...
    description: 'fd.features.typescript',
  ...
  },
  {
    ...
    description: 'fd.features.ngxtranslate',
  ...
  },
  {
    ...
    description: 'fd.features.fontawesome',
  ...
  },
  {
    ...
    description: 'fd.features.cypress',
    github: 'https://github.com/cypress-io/cypress',
    documentation: 'https://www.cypress.io/'
  },
  {
    name: 'fd.features.themes.title',
    description: 'fd.features.themes.description',
    documentation: 'https://material.angular.io/guide/theming',
    medium:
      'https://medium.com/@tomastrajan/the-complete-guide-to-angular-material-themes-4d165a9d24d1'
  },
  {
    name: 'fd.features.lazyloading.title',
    description: 'fd.features.lazyloading.description',
    documentation:
  ...
  },
  {
    ...
    description: 'fd.features.eslint',
